...
namespace OnlineShopping.Model.DomainModel.DTO.EF
{
    ...
    public partial class OnlineShoppingEntities : DbContext
    {
        ...
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("USP_Category_Edit");
        }
        ...
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("USP_Category_Select");
        }
